...
def skill_cache_roots(skill_name: str) -> dict[str, Path]:
    """Return cache/results roots for a given skill name (project-aware)."""
...
def parse_mcpc_payload(raw: Any) -> Any:
    """Extract nested JSON payload when mcpc wraps it in content[0].text."""
