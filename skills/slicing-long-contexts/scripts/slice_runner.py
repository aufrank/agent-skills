#!/usr/bin/env python
"""
Slice runner (formerly rlm_cli_runner): implements the REPL-style pattern from the RLM paper.
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Slice runner (REPL-style slicing + sub-calls).")
